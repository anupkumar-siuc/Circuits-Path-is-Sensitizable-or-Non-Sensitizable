...
typedef struct NODE_type
{
  ...
  int typ,nfi,nfo,mar,mark,po;    //type, no of fanins, no of fanouts, mark, primary output
  LIST *fin,*fot;            //fanin members, fanout members 
  DdNode *fun;              //BDDS of function
  DdNode *tempp1;              //BDDS of function
  DdNode *tempp2;              //BDDS of function
  DdNode *p0;              //BDDS of function
  DdNode *p1;              //BDDS of function
  DdNode *p2;              //BDDS of function
  DdNode *func0;              //BDDS of function
  DdNode *func1;              //BDDS of function
} NODE;
/***************************************************************************************************************************
